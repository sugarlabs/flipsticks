...
class StoredFrame(KeyFrame):
    def __init__(self, data=None):
        if not data:
            ...
            self.x = theme.scale_keyframe(data['x'])
            self.middle = theme.scale_middle(data['middle'])
    ...
    def collect(self):
        return {
            'x': theme.unscale_keyframe(self.x),
            'middle': theme.unscale_middle(self.middle),
            'parts': self.parts,
            'sticks': self.sticks,
            'joints': self.joints
        }
